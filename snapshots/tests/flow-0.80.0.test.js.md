# Snapshot report for `tests/flow-0.80.0.test.js`

The actual snapshot is saved in `flow-0.80.0.test.js.snap`.

Generated by [AVA](https://ava.li).

## flow 0.80.0: with ignored files and 1 error
...
## flow 0.80.0: with ignored files and multiple errors
...
## flow 0.80.0: with ignored files and no errors
...
## flow 0.80.0: with included files and 1 error
...
## flow 0.80.0: with included files and multiple errors
...
## flow 0.80.0: with included files and no errors
